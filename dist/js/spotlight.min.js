...
function ab(a){setTimeout(function(){K.removeChild(q);L=M=P=E=ta=D=va=wa=xa=Da=null},200);d(K,"hide-scrollbars");d(q,"show");bb(!1);qb();history.go(!0===a?-1:-2);Q&&(Ka.src="");R&&W();M&&xb(M);S&&(S=clearTimeout(S));z&&fb();I&&d(q,I);xa&&xa()}function xb(a){if(a.g)a.g.appendChild(a),a.g=null;else{var b=a.parentNode;b&&b.removeChild(a);a.src=a.onerror=""}}function hb(a){a&&X();if(1<C){if(1<B)return Hb(B-1);if(G)return Ab(C,!0),Hb(C)}}
